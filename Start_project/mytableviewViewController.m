...
- (void)viewDidLoad
{
    ...
    ary=[[NSMutableArray alloc]initWithObjects:@"one",@"tt",@"rr", nil];
    ...
    // Uncomment the following line to preserve selection between presentations.
     ...
     // train ki patri is the last place to live as per the rule
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    CollectionViewController *detailViewController = [[CollectionViewController alloc] initWithNibName:@"CollectionViewController" bundle:nil];
